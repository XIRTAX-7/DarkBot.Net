...
function run() {
    ...
    document.getElementById("MovementPort").onchange = () => {
        ipcRenderer.send("SetOptionConfig", "MovementPort", document.getElementById("MovementPort").value);
    }

    document.getElementById("MovementTimeout").onchange = () => {
        ipcRenderer.send("SetOptionConfig", "MovementTimeout", document.getElementById("MovementTimeout").value);
    }
...
function load(data) {
    ...
    if (data.MovementPort) {
        document.getElementById("MovementPort").value = data.MovementPort;
    }

    document.getElementById("MovementTimeout").value = data.MovementTimeout || 15000;
}

...
namespace DarkBot.Net.Infrastructure.Hosting;
...
public sealed class VerifierSidecarHostedService : BackgroundService
{
    ...
    public VerifierSidecarHostedService(
        IOptions<DarkBotUiOptions> options,
        ILogger<VerifierSidecarHostedService> logger)
    {

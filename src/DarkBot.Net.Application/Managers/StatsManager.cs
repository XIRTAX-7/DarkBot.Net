...
using StatImpl = DarkBot.Net.Application.Statistics.StatImpl;
using AverageStatImpl = DarkBot.Net.Application.Statistics.AverageStatImpl;
using StatKey = DarkBot.Net.Application.Statistics.StatKey;

...
namespace DarkBot.Net.Ui;

public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddDarkBotUi(this IServiceCollection services)
    {
        ...
        services.AddSingleton<PluginPanelViewModel>();
    ...
    public static IHost BuildDarkBotHost(string[] args, IConfiguration configuration) =>
        Host.CreateDefaultBuilder(args)
            ...
            .ConfigureServices(services => services.AddDarkBotUi())
            .Build();
}
